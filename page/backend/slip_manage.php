        ...
        <div class="mb-2 ">
            <div class="row">
                <div class="col me-2">
                    ...
                    <input type="text" id="fname" class="form-control bg-from dedazen_boder" value="<?php echo $bank['fname']; ?>">
                </div>
                <div class="col">
                    <p class="m-0 text-secondary">นามสกุล<span class="text-danger">*</span></p>
                    <input type="text" id="lname" class="form-control bg-from dedazen_boder" value="<?php echo $bank['lname']; ?>">
                </div>
            </div>
        </div>
        <div class="mb-4 ">
            <p class="m-0 text-secondary">เลขบัญชี<span class="text-danger">*</span></p>
            <input type="text" id="bnum" class="form-control bg-from dedazen_boder" value="<?php echo $bank['bnum']; ?>">
        </div>


         <div class="mb-4 ">
            <p class="m-0 text-secondary">Qrcode สำหรับสแกน<span class="text-danger">*</span></p>
            <input type="text" id="qrcode" class="form-control bg-from dedazen_boder" value="<?php echo $bank['qrcode']; ?>">
        </div>
