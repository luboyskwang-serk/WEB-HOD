...
<div class="container-sm mt-2  p-4 mb-4 ">
    ...
    <div class="col-lg-6 m-auto">
        <div class="mb-2 mt-4">
            ...
            <select class="form-select bg-from dedazen_boder" id="pop_1" aria-label="Default select example">
                <?php
        ...
        <div class="mb-3 mt-4">
            ...
            <select class="form-select bg-from dedazen_boder" id="pop_2" aria-label="Default select example">
                <?php
                $find = dd_q("SELECT * FROM crecom ");
                $data =  $find->fetch(PDO::FETCH_ASSOC);
                if ($data['recom_2'] != "0") {
