    ...
    <div class="table-responsive mt-3 ">
        <table id="table" class="table mt-2">
            ...
            <tbody>
                ...
                ?>
                    <tr>
                        <td class="text-center" style="font-size:13px; color:#e8e8e8"><?php echo $row['c_id']; ?></td>
                        <td class="text-dark"><img style="border-radius:1vh;" src="<?php echo htmlspecialchars($row['img']); ?>" width="100px" alt=""></td>
                        <td class="text-center" style="font-size:13px; color:#e8e8e8""><?php echo htmlspecialchars($row['c_name']); ?></td>
                        <td class="text-center" style="font-size:13px; color:#e8e8e8"><?php echo htmlspecialchars($row['des']); ?></td>
