<div class="container mb-3" style="margin-top: 20px;">
    <div class="card bg-black" style="border-radius: 1vh;">
...
<h5 class="text-main font-bold text-center">Order Premium Application History</h5>
    ...
    <div class="table-responsive">
        <table class="table" id="table">
            ...
            <tr>
                ...
                <th scope="col" class="text-white text-center">ผู้สั่งซื้อ</th>
            ...
            <tbody>
    <?php 
        $q = dd_q("SELECT * FROM boxlogapp ORDER BY id DESC");
    ...
    ?>
             <tr>
                ...
                <td class="text-center w-50" style="color:#aaaaaa;" id="<?php echo number_format($i);?>"><?php echo $row['name'];?><br><?php 
            ...
            <td class="text-center text-white"><?php echo $row['username'];?></td>
            <td class="text-center text-white"><?php $time = $row['date']; echo time_elapsed_string("$time");?></td>
                <td class="text-dark text-center"><button class="btn btn-sm btn-warning mb-2 border p-3" data-bs-toggle="modal" data-bs-target="#report<?=$row['product_id'];?>">🛒 เคลมสินค้า</button></td>
            </tr>
