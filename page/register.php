...
<style>
    ...
    .dedaf {
            ...
            .dedaf {
                ...
                text-transform: uppercase;
                font-weight: 400;
                background: linear-gradient(to right,#2a4230 10%, #89dd81  30%, #89dd81 60% , #2a4230 100%) ;
...
#discord-button {
  ...
  a {
    ...
    width: 100%;
    display: flex;
    justify-content: center; /* จัดเรียงตรงกลางในแนวนอน */
 ...
 #line-button {
    ...
    <div class="container-fluid p-0 mt-4 ">
        <div class="container-sm m-cent ps-4 pe-4" style=" margin-bottom: 4em!important;">
            <div class="container-fluid p-4 card-dz ">
                ...
                <div class="container-fluid ps-0 pe-0" style="margin-top: 1em;">
                    <div class="col-lg-8 m-cent">
                        ...
                        <div class="mb-1">
                            <label class="mb-2 mt-1"> Email</label>
                            <input type="email" class="bb form-control-lg  w-100 text-or" style="font-size:14px;" id="email" placeholder="อีเมล์" aria-describedby="basic-addon1">
                        </div>
                        <div class="mb-1">
                        ...
                        <!-- div class="mb-1 mt-2 text-white">
                            <input class="form-check-input" type="checkbox" role="switch" id="accept">
                            <h6 class="dedaf" id="acceptText"><i class="fa-solid fa-check-to-slot fa-bounce dedaf"></i> ยอมรับเงื่อนไขและการให้บริการ</h6>
                            <span class="text-white" data-bs-toggle="modal" data-bs-target="#acceptmodal">> อ่านเงื่อนไข <</span>
                        </div -->


                                <?php
                                    if($config['oaccept'] == 1){
                                        echo " <input class='form-check-input' type='checkbox' role='switch' id='accept'> <span class='ms-2' style='width: fit-content; color:#d6d6d6; font-size:14px;'>ยอมรับ 
                                            </span> <a href='https://khunbaimai.in.th/?page=register' style='text-decoration:none; color:#f0c929'>เงื่อนไขและข้อตกลง </a>";
                                    }else{
                        ...
                        <br>
                        <button class="btn btn-dz text-white  ps-4 pe-4  pt-2 pb-2 w-100 d-inline" id="btn_regis"><i class="fa-solid fa-arrow-right"></i>&nbsp;สมัครสมาชิก</button>
                        <hr />
                        <div id="line-button" >
                                ...
                                <div id="discord-button" class="mt-2">
                                    <a href='/auth/discord.php' target="_blank">
                                        ...
                                        <svg id="Layer_1" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 245 240">
                                            ...
                                            <span>สมัครสมาชิกด้วย Discord</span>
                                 ...
                                 <center class="mt-4">
                                    <p class="text-secondary  mt-2"   ><a href="?page=login" class="text-secondary " style="text-decoration: none;">
                                <i class="fa-sharp fa-regular fa-arrow-right-to-arc fa-fade"></i>&nbsp;เข้าใช้งานหากมีบัญชีแล้ว</a></p>
                                </center>
...
var acceptValue = ""; // สร้างตัวแปรเพื่อเก็บค่า accept

    $("#accept").change(function() {
        if ($(this).is(":checked")) {
            acceptValue = "1"; // ถ้า checkbox ถูกเลือกให้เก็บค่าเป็น 1
        } else {
            acceptValue = "0"; // ถ้า checkbox ไม่ถูกเลือกให้เก็บค่าเป็น 0
        }
    });
$("#btn_regis").click(function(e) {
    ...
    formData.append('accept', acceptValue);
